...
class SearchForm(FlaskForm):
    stadName = StringField('stadName', validators=[
...
class SignupForm(FlaskForm):
    signUsername = StringField('signUsername',
                               validators=[
                                   DataRequired(), Length(min=0, max=100)],
                               render_kw={"placeholder": "Username"})
    signPassword = PasswordField('signPassword', validators=[
        DataRequired(), Length(min=0, max=100)],
        render_kw={"placeholder": "Password"})
    signName = StringField('signName', validators=[
        DataRequired(), Length(min=0, max=100)],
...
class LoginForm(FlaskForm):
    loginName = StringField('loginName', validators=[
        DataRequired(), Length(min=0, max=100)],
        render_kw={"placeholder": "Username"})
    loginPassword = PasswordField('loginPassword', validators=[
        DataRequired(), Length(min=0, max=100)],
        render_kw={"placeholder": "Password"})
...
class ReviewForm(FlaskForm):
    ...
    reviewText = StringField('reviewText',  validators=[
...
class EditName(FlaskForm):
    ...
    sameName = StringField('sameName', validators=[
        DataRequired(), Length(min=0, max=100)],
